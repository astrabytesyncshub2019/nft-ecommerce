...
const Duffles = () => {
  ...
  return (
    <div
      className="relative w-full bg-gradient-to-br from-orange-100 via-white to-red-100 px-4 sm:px-6 md:px-12 py-16 sm:py-20 lg:py-24 overflow-hidden"
    >
      ...
      <div className="text-center mb-16 relative">
        ...
        <h2
          className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 tracking-tighter uppercase bg-gradient-to-r from-gray-900 via-orange-800 to-red-800 bg-clip-text text-transparent leading-tight"
        >
          Duffles
        </h2>

        <div className="relative h-px bg-gradient-to-r from-transparent via-orange-300 to-transparent mb-6 max-w-xs mx-auto"></div>
